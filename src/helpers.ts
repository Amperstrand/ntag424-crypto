 ...
 */
export function extractUIDAndCounter(pHex: string, k1Keys: Uint8Array[]): ExtractResult {
...
export function decodeAndValidate(
  ...
  if (!decryption.success) {
    return { success: false, cmac_validated: false, cmac_error: null, error: (decryption as ExtractFailure).error };
  }
